...
from utils.validation import validate_records  # noqa: E402
...
def test_price_required_drops_missing_price():
    df = pd.DataFrame(
        [
            ...
            {
                "venue": "Melkweg",
                "start_date_time": "2025-12-22 21:00",
                "ticket_url": "https://y",
                "price": None,
            },
            {
                "venue": "Concertgebouw",
                "start_date_time": "2025-12-23 19:30",
                "ticket_url": "https://z",
                "price": 25.0,
            },
        ]
    ...
    assert (
        not validated[(validated["venue"] == "Concertgebouw") & (validated["price"].isna())]
        .any()
        .any()
    )
